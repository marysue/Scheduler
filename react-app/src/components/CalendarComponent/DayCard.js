...
export default function DayCard({datesBlocked, placementDates, day, handleDateClicked}) {
...
if (day) {
  return (
    <Card className={classes.gridContainer}>
      <CardContent className={classes.root} onClick={ (e) => handleDateClicked(e, day)}>
        <div width="120" height="120">{day.format("D").toString()}</div>
      </CardContent>
    </Card>
  );
} else { return null }
