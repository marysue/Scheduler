...
def seed_users():
    ...
    d4 = User(username='Dentist 1', email='dentist1@dentist1.com', password='password', userType='')
    ...
    d10 = User(username='Company 1', email='co1@co1.com', password='password', userType='contractor')
    d11 = User(username='Company 2', email='co2@co2.com', password='password', userType='contractor')
