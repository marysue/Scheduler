...
def seed_placements():
    ...
    pl1 = Placement(contractorId_fk=2, companyId_fk=1, companyContactId_fk=1,startDate=datetime.strptime('12/20/20', '%m/%d/%y'), endDate=datetime.strptime('12/24/20', '%m/%d/%y'))
    pl2 = Placement(contractorId_fk=2, companyId_fk=1, companyContactId_fk=1,startDate=datetime.strptime('12/19/20', '%m/%d/%y'), endDate=datetime.strptime('12/19/20', '%m/%d/%y'))
    pl3 = Placement(contractorId_fk=2, companyId_fk=2, companyContactId_fk=5,startDate=datetime.strptime('12/29/20', '%m/%d/%y'), endDate=datetime.strptime('12/29/20', '%m/%d/%y'))
